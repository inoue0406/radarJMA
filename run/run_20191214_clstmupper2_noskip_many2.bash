...
case="result_20191214_clstmupper2_alljpn_lr002_flt"
...
python ../src/main_CLSTM_EP_jma.py --model_name clstm_upper\
       ...
       --train_path ../data/train_alljapan_2015_JMARadar.csv \
       --valid_path ../data/train_alljapan_2015_JMARadar.csv \
...
case="result_20191214_clstmupper2_alljpn_lr002_d7_flt"
...
case="result_20191214_clstmupper2_alljpn_lr004_flt"
...
python ../src/main_CLSTM_EP_jma.py --model_name clstm_upper\
       ...
       --valid_path ../data/train_alljapan_2015_JMARadar.csv \
       --test --eval_threshold 0.5 10 20 --test_path ../data/valid_simple_JMARadar.csv \
       --result_path $case --tdim_use 12 --learning_rate 0.04 --lr_decay 0.9 \
       --batch_size 10 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --hidden_channels 8 --kernel_size 3 --optimizer adam

case="result_20191214_clstmupper2_alljpn_lr004_d7_flt"
...
python ../src/main_CLSTM_EP_jma.py --model_name clstm_upper\
       ...
       --valid_path ../data/train_alljapan_2015_JMARadar.csv \
       --test --eval_threshold 0.5 10 20 --test_path ../data/valid_simple_JMARadar.csv \
       --result_path $case --tdim_use 12 --learning_rate 0.04 --lr_decay 0.7 \
       --batch_size 10 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --hidden_channels 8 --kernel_size 3 --optimizer adam
